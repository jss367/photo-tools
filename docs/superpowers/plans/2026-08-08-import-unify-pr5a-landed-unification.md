...
- [ ] **Step 5:** Full file (timeout 600000) → expect 222-223 passed (220 + flip pins added minus the collapsed pair — recount honestly and report), 1 skipped. Commit: `"Fold remote adoptions into landed: hash-status stamp, WC override, unified failure reporting (spec divergence 10 + PR 5a flips)"`
